        ...
        <div class="main-container">
            ...
            <div class="col-sm p-3 min-vh-100">
                <div class="">
                    ...
                    <div
                         style="max-width: 600px; margin: 50px auto; padding: 20px; border: 1px solid #526E48; border-radius: 10px; background-color: #F9F9F9; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif;">
                        ...
                        <div>
                            <form method="post" action="" style="display: flex; flex-direction: column; gap: 15px;">
                                ...
                                <label name="regAs" for="type" style="font-size: 14px; color: #526E48;">Register
                                    as:</label>
                                <select name="user_types" id="usertype"
                                        style="padding: 8px; border: 1px solid #526E48; border-radius: 5px; background-color: #FFF; color: #526E48; font-size: 14px;">
                                ...
                                <input type="text" name="username" required
                                       style="padding: 8px; border: 1px solid #526E48; border-radius: 5px; font-size: 14px; color: #526E48; background-color: #FFF;">
                                ...
                                <input type="submit" value="SUBMIT" name="submit"
                                       style="padding: 10px; font-size: 16px; color: white; background-color: #526E48; border: none; border-radius: 5px; cursor: pointer; text-transform: uppercase;">
                            </form>
                        </div>
                    </div>
