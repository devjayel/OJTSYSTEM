...
<head>
    ...
    <link rel="stylesheet" href="../src/css/student/studSettingsStyle.css">
        ...
        <div class="sidebar-container">
            ...
            <div class="col-sm p-3 min-vh-100">
                <div class="container-xxl">
                    ...
                    <a class="btn btn-secondary" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop" role="button"> Change Password</a>
                                        ...
                                        <div class="row justify content-start">
                                            <div class="col-3">
                                                <img src="./image/<?php echo $row['image'] ?> "
                                                    class="img-fluid rounded-circle rounded" style="width: 10rem; height:10rem;"
                                                    alt="...">
                                            </div>
                                            <div class="col-5">
                                                <div class="labels">
                                                    <label type="text" name="name"
                                                        id="inputtext6"><?php echo $row['lastName'] ?>,
                                                        <?php echo $row['firstName'] ?>
                                                        <?php echo $row['middleName'] ?></label><br>
                                                    <label type="text" name="studentId"
                                                        id="inputtext6"><?php echo $row['studentid'] ?></label> <br>
                                                    <label type="text" name="yearProg"
                                                        id="inputtext6"><?php echo $row['yearProg'] ?></label>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="labels2">
                                                    <br>
                                                    <i class="bi bi-envelope-at-fill"> </i> <label type="text" name="email"
                                                        id="inputtext6"><?php echo $row['email'] ?></label> <br>
                                                    <i class="bi bi-telephone-fill"> </i> <label type="text" name="contact_no"
                                                        id="inputtext6"><?php echo $row['contactNum'] ?></label>
                                    ...
                                    <div class="analytics-container  mb-5 ">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                onchange="document.getElementById('update').disabled = !this.checked;">
                                            <label class="form-check-label" for="flexSwitchCheckDefault">Click to enable edit
                                            </label>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="last_name" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['lastName'] ?>">
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <input type="email" name="email" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['email'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="inputtext6" class="col-form-label">First Name:</label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" name="first_name" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['firstName'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="middle_name" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['middleName'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="inputtext6" class="col-form-label">Year-Course:</label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" name="year_course" id="inputtext6"
                                                    placeholder="4th Year-BSIT" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['yearProg'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $student_id ?>"
                                                    readonly>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="date" name="birth_date" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['birthDate'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="inputtext6" class="col-form-label">Contact No:</label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="number" name="contact_no" id="inputtext6" class="form-control"
                                                    aria-describedby="textHelpInline" value="<?php echo $row['contactNum'] ?>">
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="text-center "> <input type="submit" class="btn btn-primary" style="background-color: #62825D"
                                                    name="submit" value="Submit" id="update" disabled>
                                            </div>
                                        </div>
                            </form>
